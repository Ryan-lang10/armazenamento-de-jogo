...
# Dicionário que armazena os jogos da loja
produtos = {
    "fifa 25": {"preço": 250.00, "estoque": 40},
    "the last of us": {"preço": 222.00, "estoque": 30},
    "gta grand theft auto": {"preço": 123.00, "estoque": 50},
}
...
def realizar_venda():
    global total_vendas
    produto_vendido = input("Digite o nome do jogo que deseja comprar: ")
